        ...
        <div class="col">
            <div class="row">
                <div class="col-lg-4 p-0">
                    <a href="/university" class="card rounded-0 fill-vertical">
                        <div class="card-body">
                ...
                <div class="col-lg-4 p-0">
                    <a href="http://numerical-method.fedorenko.zzz.com.ua/" class="card rounded-0 fill-vertical">
                        <div class="card-body">
                ...
                <div class="col-lg-4 p-0">
                    <a href="http://taskman.adr.com.ua/" class="card rounded-0">
                        <div class="card-body">
